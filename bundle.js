...
var app = (function () {
    ...
    */
    ...
    var luxon_3 = luxon.FixedOffsetZone;
    var luxon_4 = luxon.IANAZone;
    var luxon_5 = luxon.Info;
    var luxon_6 = luxon.Interval;
    var luxon_7 = luxon.InvalidZone;
    var luxon_8 = luxon.LocalZone;
    var luxon_9 = luxon.Settings;
    var luxon_10 = luxon.Zone;
    ...
    ***************************************************************************** */
    ...
    function processEvent(dwd, event, date, data, options) {
        ...
        var _edt = event.repeat ?
            (event.endDate ? luxon_1.fromFormat(event.endDate, options.format, { locale: options.parserLocale })
    ...
    function processEvents(events, options) {
        ...
        try {
            for (var _d = __values(Object.entries(events)), _e = _d.next(); !_e.done; _e = _d.next()) {
                ...
                _dt = luxon_1.fromFormat(date, options.format, { locale: options.parserLocale });
                try {
                    for (var _events_1 = (e_2 = void 0, __values(_events)), _events_1_1 = _events_1.next(); !_events_1_1.done; _events_1_1 = _events_1.next()) {
                        ...
                        if (event.repeat === 'INTERVAL') {
                            event = __assign({}, event, { repeat: luxon_5.weekdaysFormat('short', { locale: options.parserLocale }).join(',') });
                        }
    ...
    var Today = /** @class */ (function (_super) {
        ...
        function Today(today, options) {
            ...
            _this.weekdays = luxon_5.weekdaysFormat(options.weekNameLength);
            _this.months = luxon_5.monthsFormat(options.monthNameLength);
            return _this;
        }
    ...
    var Calendario = /** @class */ (function (_super) {
        ...
        Object.defineProperty(Calendario.prototype, "body", {
            get: function () {
                ...
                var _td = luxon_1.local().startOf('day');
        ...
        Calendario.prototype.now = function () {
            return this.toDate(luxon_1.local().toJSDate());
        };
        return Calendario;
    }(Today));
    ...
    function calendario(events, options, today) {
        ...
        var zone;
        luxon_9.throwOnInvalid = true;
        options = __assign({}, DEFAULTS, options);
        var resolvedOpts = luxon_1.fromObject({ locale: options.locale, numberingSystem: options.numberingSystem }).resolvedLocaleOpts();
        if (!(zone = luxon_5.normalizeZone(options.timeZone)).isValid) {
            throw new TimeZoneError("Invalid timezone " + options.timeZone);
        }
        luxon_9.defaultZoneName = zone.name;
        luxon_9.defaultLocale = resolvedOpts.locale;
        luxon_9.defaultNumberingSystem = resolvedOpts.numberingSystem;
        luxon_9.defaultOutputCalendar = 'gregory';
        var _today = (today ? luxon_1.fromJSDate(today) : luxon_1.local()).setLocale(options.parserLocale);
    ...
    // (24:20) {#each cal.head as weekday}
    function create_each_block_3(ctx) {
    	var div, t_value = ctx.weekday, t;

    	return {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			add_location(div, file, 24, 24, 1260);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((changed.cal) && t_value !== (t_value = ctx.weekday)) {
    				set_data(t, t_value);
    			}
    		},
    ...
    function create_else_block(ctx) {
    	var span, t_value = ctx.event.content, t, span_class_value;

    	return {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr(span, "class", span_class_value = ctx.event.category);
    			add_location(span, file, 47, 52, 2650);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((changed.body || changed.rows) && t_value !== (t_value = ctx.event.content)) {
    				set_data(t, t_value);
    			}

    			if ((changed.body || changed.rows) && span_class_value !== (span_class_value = ctx.event.category)) {
    ...
    function create_if_block(ctx) {
    	var a, t_value = ctx.event.content, t, a_class_value, a_href_value;

    	return {
    		c: function create() {
    			a = element("a");
    			t = text(t_value);
    			attr(a, "class", a_class_value = ctx.event.category);
    			attr(a, "href", a_href_value = ctx.event.url);
    			add_location(a, file, 45, 52, 2475);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((changed.body || changed.rows) && a_class_value !== (a_class_value = ctx.event.category)) {
    				attr(a, "class", a_class_value);
    			}

    			if ((changed.body || changed.rows) && a_href_value !== (a_href_value = ctx.event.url)) {
    ...
    // (43:40) {#each dt.events as event}
    function create_each_block_2(ctx) {
    	var div;

    	function select_block_type(ctx) {
    		if (ctx.event.url) return create_if_block;
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			attr(div, "class", "fc-calendar-event");
    			add_location(div, file, 43, 44, 2327);
    		},
    ...
    // (32:28) {#each body[ri] as dt}
    function create_each_block_1(ctx) {
    	var div1, span0, t0_value = ctx.dt.date.day, t0, t1, span1, t2_value = ctx.dt.weekday, t2, t3, div0, div1_class_value;

    	var each_value_2 = ctx.dt.events;
    	...
    	return {
    		c: function create() {
    			...
    			attr(span0, "class", "fc-date");
    			toggle_class(span0, "fc-emptydate", ctx.dt.events.length === 0);
    			add_location(span0, file, 38, 36, 1942);
    			attr(span1, "class", "fc-weekday");
    			add_location(span1, file, 39, 36, 2065);
    			attr(div0, "class", "fc-calendar-events");
    			add_location(div0, file, 41, 36, 2183);
    			attr(div1, "class", div1_class_value = "" + ctx.dt.dateClass + " " + ctx.dt.weekday);
    			toggle_class(div1, "fc-past", ctx.dt.past);
    			toggle_class(div1, "fc-future", ctx.dt.future);
    			toggle_class(div1, "fc-today", ctx.dt.today);
    			toggle_class(div1, "fc-content", ctx.dt.events.length > 0);
    			add_location(div1, file, 32, 32, 1564);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((changed.body || changed.rows) && t0_value !== (t0_value = ctx.dt.date.day)) {
    				set_data(t0, t0_value);
    			}

    			if ((changed.body || changed.rows)) {
    				toggle_class(span0, "fc-emptydate", ctx.dt.events.length === 0);
    			}

    			if ((changed.body || changed.rows) && t2_value !== (t2_value = ctx.dt.weekday)) {
    				set_data(t2, t2_value);
    			}

    			if (changed.body || changed.rows) {
    				each_value_2 = ctx.dt.events;
    			...
    			if ((changed.body || changed.rows) && div1_class_value !== (div1_class_value = "" + ctx.dt.dateClass + " " + ctx.dt.weekday)) {
    				attr(div1, "class", div1_class_value);
    			}

    			if ((changed.body || changed.rows || changed.body || changed.rows)) {
    				toggle_class(div1, "fc-past", ctx.dt.past);
    				toggle_class(div1, "fc-future", ctx.dt.future);
    				toggle_class(div1, "fc-today", ctx.dt.today);
    				toggle_class(div1, "fc-content", ctx.dt.events.length > 0);
    ...
    // (30:20) {#each Array.from(Array(rows).keys()) as ri}
    function create_each_block(ctx) {
    	var div, t;

    	var each_value_1 = ctx.body[ctx.ri];
    	...
    	return {
    		c: function create() {
    			...
    			t = space();
    			attr(div, "class", "fc-row");
    			add_location(div, file, 30, 24, 1460);
    		},
    ...
    function create_fragment(ctx) {
    	var div6, div5, div0, h2, t0, span1, span0, t2, h3, span2, t3, span3, t4, nav, span4, t5, span5, t6, span6, t7, div4, div3, div1, t8, div2, dispose;

    	var each_value_3 = ctx.cal.head;
    	...
    	var each_value = Array.from(Array(ctx.rows).keys());
    	...
    	return {
    		c: function create() {
    			...
    			span1 = element("span");
    			span0 = element("span");
    			span0.textContent = "Example Svelte";
    			t2 = space();
    			h3 = element("h3");
    			span2 = element("span");
    			t3 = space();
    			...
    			add_location(span0, file, 4, 22, 179);
    			add_location(span1, file, 4, 16, 173);
    			add_location(h2, file, 3, 12, 141);
    			attr(span2, "id", "custom-month");
    			attr(span2, "class", "custom-month");
    			add_location(span2, file, 7, 16, 291);
    			attr(span3, "id", "custom-year");
    			attr(span3, "class", "custom-year");
    			add_location(span3, file, 8, 16, 360);
    			attr(span4, "id", "custom-prev");
    			attr(span4, "class", "custom-prev");
    			attr(span4, "title", "Go to previous month");
    			add_location(span4, file, 10, 20, 453);
    			attr(span5, "id", "custom-next");
    			attr(span5, "class", "custom-next");
    			attr(span5, "title", "Go to next month");
    			add_location(span5, file, 11, 20, 597);
    			attr(span6, "id", "custom-current");
    			attr(span6, "class", "custom-current");
    			attr(span6, "title", "Go to current date");
    			add_location(span6, file, 12, 20, 733);
    			add_location(nav, file, 9, 16, 427);
    			attr(h3, "class", "custom-month-year");
    			add_location(h3, file, 6, 12, 244);
    			attr(div0, "class", "custom-header clearfix");
    			add_location(div0, file, 2, 8, 92);
    			attr(div1, "class", "fc-head");
    			add_location(div1, file, 22, 16, 1166);
    			attr(div2, "class", "fc-body");
    			add_location(div2, file, 28, 16, 1349);
    			attr(div3, "class", "fc-calendar");
    			toggle_class(div3, "fc-four-rows", ctx.rows === 4);
    			toggle_class(div3, "fc-five-rows", ctx.rows === 5);
    			toggle_class(div3, "fc-six-rows", ctx.rows === 6);
    			add_location(div3, file, 17, 12, 977);
    			attr(div4, "id", "calendar");
    			attr(div4, "class", "fc-calendar-container");
    			add_location(div4, file, 16, 8, 915);
    			attr(div5, "class", "custom-calendar-wrap custom-calendar-full");
    			add_location(div5, file, 1, 4, 28);
    			attr(div6, "class", "container");
    			add_location(div6, file, 0, 0, 0);

    			dispose = [
    				listen(span4, "click", ctx.click_handler),
    				listen(span5, "click", ctx.click_handler_1),
    				listen(span6, "click", ctx.click_handler_2)
    			];
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.body || changed.rows) {
    				each_value = Array.from(Array(ctx.rows).keys());
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function click_handler() {
    		const $$result = cal = cal.previousMonth();
    		$$invalidate('cal', cal);
    		return $$result;
    	}

    	function click_handler_1() {
    		const $$result = cal = cal.nextMonth();
    		$$invalidate('cal', cal);
    		return $$result;
    	}

    	function click_handler_2() {
    		const $$result = cal = cal.now();
    		$$invalidate('cal', cal);
    		return $$result;
    	}
    	...
    	$$self.$$.update = ($$dirty = { cal: 1 }) => {
    		if ($$dirty.cal) { $$invalidate('rows', rows = cal.rows); }
    		if ($$dirty.cal) { $$invalidate('body', body = cal.body); }
    	};
